...
BEGIN
    ...
    IF v_p005_id IS NOT NULL THEN
        ...
        INSERT INTO public.project_issues (project_id, code, type, title, priority, status, due_date, pic) VALUES
        (v_p005_id, 'NCR-105', 'NCR', 'Bề mặt bê tông cột trục 2-C bị rỗ dăm', 'Medium', 'Open', '2026-01-18', 'Nguyễn Văn An'),
        ...
        (v_p005_id, 'Anh-Nghiem-thu-Cach-nhiet-Mai.jpg', 'jpg', 4194304, 'https://images.unsplash.com/photo-1581094794329-c8112a89af12?q=80&w=800&auto=format&fit=crop', 'Nguyễn Văn An');
    END IF;
END $$;
