...
BEGIN
    ...
    INSERT INTO invoices (invoice_code, invoice_type, project_id, vendor_name, invoice_date, due_date, total_amount, paid_amount, outstanding_amount, status)
    VALUES
    -- Sales Invoices (AR)
    ('INV-AR-001', 'sales', gs_id, 'Lux Decor Việt Nam', '2024-12-01', '2025-01-01', 5000000000, 5000000000, 0, 'paid'),
    ('INV-AR-002', 'sales', br_id, 'Brother Industries', '2024-12-05', '2025-01-05', 12000000000, 0, 12000000000, 'pending'),
    ('INV-AR-003', 'sales', tci_id, 'TCI Precision', '2024-12-10', '2025-01-10', 8500000000, 4000000000, 4500000000, 'pending'),
    ('INV-AR-004', 'sales', dr_id, 'Dream Group', '2024-11-20', '2024-12-20', 3200000000, 3200000000, 0, 'paid'),
    ('INV-AR-005', 'sales', gz_id, 'Gamuda Land', '2024-12-15', '2025-01-15', 15000000000, 0, 15000000000, 'pending'),
    ('INV-AR-006', 'sales', ts_id, 'UBND Tiên Sơn', '2024-10-30', '2024-11-30', 4500000000, 4500000000, 0, 'paid'),
    ('INV-AR-007', 'sales', gs_id, 'Lux Decor Việt Nam', '2024-11-01', '2024-12-01', 2500000000, 2500000000, 0, 'paid'),
    ('INV-AR-008', 'sales', br_id, 'Brother Industries', '2024-10-15', '2024-11-15', 7800000000, 7800000000, 0, 'paid'),
    ('INV-AR-009', 'sales', tci_id, 'TCI Precision', '2024-09-20', '2024-10-20', 1200000000, 1200000000, 0, 'paid'),
    ('INV-AR-010', 'sales', dr_id, 'Dream Group', '2024-08-25', '2024-09-25', 9800000000, 9800000000, 0, 'paid'),
    ('INV-AR-011', 'sales', gs_id, 'Lux Decor Việt Nam', '2025-01-05', '2025-02-05', 6200000000, 0, 6200000000, 'pending'),
    ('INV-AR-012', 'sales', gz_id, 'Gamuda Land', '2025-01-08', '2025-02-08', 4300000000, 0, 4300000000, 'pending'),
    
    -- Purchase Invoices (AP)
    ('INV-AP-001', 'purchase', gs_id, 'Thép Hòa Phát', '2024-12-20', '2025-01-20', 1200000000, 0, 1200000000, 'pending'),
    ('INV-AP-002', 'purchase', br_id, 'Bê tông An Việt', '2024-12-18', '2025-01-18', 850000000, 0, 850000000, 'pending'),
    ('INV-AP-003', 'purchase', tci_id, 'Điện lực Hà Nội', '2024-12-25', '2025-01-25', 120000000, 120000000, 0, 'paid'),
    ('INV-AP-004', 'purchase', dr_id, 'Cấp nước sạch', '2024-12-26', '2025-01-26', 45000000, 45000000, 0, 'paid'),
    ('INV-AP-005', 'purchase', gz_id, 'NTP Cơ điện Toàn Cầu', '2024-12-05', '2025-01-05', 3500000000, 1000000000, 2500000000, 'pending'),
    ('INV-AP-006', 'purchase', ts_id, 'Vật tư Thái Bình', '2024-12-10', '2025-01-10', 670000000, 0, 670000000, 'pending'),
    ('INV-AP-007', 'purchase', gs_id, 'Thanh nhôm Định hình', '2024-11-15', '2024-12-15', 1800000000, 1800000000, 0, 'paid'),
    ('INV-AP-008', 'purchase', br_id, 'Xi măng Hoàng Thạch', '2024-11-20', '2024-12-20', 2100000000, 2100000000, 0, 'paid'),
    ('INV-AP-009', 'purchase', tci_id, 'Đá ốp lát cao cấp', '2024-11-25', '2024-12-25', 950000000, 950000000, 0, 'paid'),
    ('INV-AP-010', 'purchase', dr_id, 'Kính cường lực ABC', '2024-11-28', '2024-12-28', 1150000000, 1150000000, 0, 'paid'),
    ('INV-AP-011', 'purchase', gs_id, 'Vận tải Hùng Vương', '2025-01-10', '2025-02-10', 280000000, 0, 280000000, 'pending'),
    ('INV-AP-012', 'purchase', gz_id, 'Sơn Dulux Việt Nam', '2025-01-12', '2025-02-12', 420000000, 0, 420000000, 'pending'),
    ('INV-AP-013', 'purchase', ts_id, 'Thiết bị vệ sinh Inax', '2025-01-14', '2025-02-14', 890000000, 0, 890000000, 'pending')
