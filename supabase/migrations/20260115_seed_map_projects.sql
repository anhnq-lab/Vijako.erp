...
('P-SUNURBAN', 'Sun Urban City Hà Nam & Lam Hạ Center Point', 'Phủ Lý, Hà Nam', 'Nguyễn Quốc Anh', 'active', 20.5422, 105.9128, 'on_track', 25, 30),
('P-ZEN', 'The Zen - Gamuda Garden', 'Hoàng Mai, Hà Nội', 'Phạm Tuấn', 'completed', 20.9735, 105.8642, 'completed', 100, 100),
('P-GREENSHADE', 'Nhà máy rèm Greenshade', 'KCN Đồng Văn, Hà Nam', 'Nguyễn Quốc Anh', 'active', 20.5833, 105.9167, 'on_track', 60, 55),
...
('P-001', 'Vijako Tower - Giai đoạn 2', 'KĐT Tây Hồ Tây, Hà Nội', 'Nguyễn Quốc Anh', 'active', 21.0667, 105.7917, 'delayed', 45, 52),
